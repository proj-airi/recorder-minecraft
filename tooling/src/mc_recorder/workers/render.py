...
from mc_recorder.config import RecorderConfig, load_runtime_env
from mc_recorder.errors import RecorderError
from mc_recorder.processing.render.hud import MAX_HUD_SIDECAR_BYTES, validate_hud_sidecar_envelope
from mc_recorder.processing.render.job import launch_render_job
...
def call_recorder_json(
    ...
    *,
    ...
    from mc_recorder.protocol.render.rpc import dispatch_render_rpc
