...
public inline fun playerListInfo(block: dev.recorderminecraft.artifacts.v1.PlayerListInfoKt.Dsl.() -> kotlin.Unit): dev.recorderminecraft.artifacts.v1.PlayerListInfo =
  dev.recorderminecraft.artifacts.v1.PlayerListInfoKt.Dsl._create(dev.recorderminecraft.artifacts.v1.PlayerListInfo.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `recorder_minecraft.artifacts.v1.PlayerListInfo`
 */
public object PlayerListInfoKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: dev.recorderminecraft.artifacts.v1.PlayerListInfo.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: dev.recorderminecraft.artifacts.v1.PlayerListInfo.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): dev.recorderminecraft.artifacts.v1.PlayerListInfo = _builder.build()
...
@kotlin.jvm.JvmName("setActions")
    ...
    /**
     * `.recorder_minecraft.artifacts.v1.EncodedValue packet = 2 [json_name = "packet"];`
     */
    public var packet: dev.recorderminecraft.artifacts.v1.EncodedValue
    ...
    public val PlayerListInfoKt.Dsl.packetOrNull: dev.recorderminecraft.artifacts.v1.EncodedValue?
      get() = _builder.packetOrNull
  }
}
@kotlin.jvm.JvmSynthetic
public inline fun dev.recorderminecraft.artifacts.v1.PlayerListInfo.copy(block: `dev.recorderminecraft.artifacts.v1`.PlayerListInfoKt.Dsl.() -> kotlin.Unit): dev.recorderminecraft.artifacts.v1.PlayerListInfo =
  `dev.recorderminecraft.artifacts.v1`.PlayerListInfoKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val dev.recorderminecraft.artifacts.v1.PlayerListInfoOrBuilder.packetOrNull: dev.recorderminecraft.artifacts.v1.EncodedValue?
