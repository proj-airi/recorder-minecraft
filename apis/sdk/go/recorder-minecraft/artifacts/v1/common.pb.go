...
func (x *Vector3) Reset() {
	*x = Vector3{}
	mi := &file_recorder_minecraft_artifacts_v1_common_proto_msgTypes[0]
...
func (*Vector3) Descriptor() ([]byte, []int) {
	return file_recorder_minecraft_artifacts_v1_common_proto_rawDescGZIP(), []int{0}
}
...
var File_recorder_minecraft_artifacts_v1_common_proto protoreflect.FileDescriptor

const file_recorder_minecraft_artifacts_v1_common_proto_rawDesc = "" +
	"\n" +
	",recorder-minecraft/artifacts/v1/common.proto\x12\x1frecorder_minecraft.artifacts.v1\"3\n" +
	"\aVector3\x12\f\n" +
	...
	"\n" +
	"media_type\x18\x04 \x01(\tR\tmediaTypeB\x87\x01\n" +
...
var (
	file_recorder_minecraft_artifacts_v1_common_proto_rawDescOnce sync.Once
	file_recorder_minecraft_artifacts_v1_common_proto_rawDescData []byte
)

func file_recorder_minecraft_artifacts_v1_common_proto_rawDescGZIP() []byte {
	file_recorder_minecraft_artifacts_v1_common_proto_rawDescOnce.Do(func() {
		file_recorder_minecraft_artifacts_v1_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_recorder_minecraft_artifacts_v1_common_proto_rawDesc), len(file_recorder_minecraft_artifacts_v1_common_proto_rawDesc)))
	})
...
func init() { file_recorder_minecraft_artifacts_v1_common_proto_init() }
func file_recorder_minecraft_artifacts_v1_common_proto_init() {
	if File_recorder_minecraft_artifacts_v1_common_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_recorder_minecraft_artifacts_v1_common_proto_goTypes,
		DependencyIndexes: file_recorder_minecraft_artifacts_v1_common_proto_depIdxs,
		MessageInfos:      file_recorder_minecraft_artifacts_v1_common_proto_msgTypes,
	}.Build()
	File_recorder_minecraft_artifacts_v1_common_proto = out.File
	file_recorder_minecraft_artifacts_v1_common_proto_goTypes = nil
	file_recorder_minecraft_artifacts_v1_common_proto_depIdxs = nil
}
