...
from mc_recorder.processing.dataset.viewer import DatasetCatalogResult, DatasetViewer


class DatasetIndex:
    """Continuously refresh the verified catalog without blocking HTTP requests."""

    def __init__(self, viewer: DatasetViewer, *, refresh_seconds: float = 5.0) -> None:
        self.viewer = viewer
